...
namespace BlogPhotographerSystem_Core.Migrations
{
    ...
    [Migration("20240814160043_add userIDForGallery")]
    partial class adduserIDForGallery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("BlogDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 541, DateTimeKind.Local).AddTicks(8860));

                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 541, DateTimeKind.Local).AddTicks(7565));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.BlogAttachement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 541, DateTimeKind.Local).AddTicks(5341));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 537, DateTimeKind.Local).AddTicks(1663));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 543, DateTimeKind.Local).AddTicks(1561));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.ContactRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 537, DateTimeKind.Local).AddTicks(9242));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Gallery", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 542, DateTimeKind.Local).AddTicks(7941));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Login", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 537, DateTimeKind.Local).AddTicks(7089));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 538, DateTimeKind.Local).AddTicks(950));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Problem", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 542, DateTimeKind.Local).AddTicks(5029));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 538, DateTimeKind.Local).AddTicks(9141));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 14, 19, 0, 43, 539, DateTimeKind.Local).AddTicks(3411));
