...
namespace BlogPhotographerSystem_Core.Migrations
{
    ...
    [Migration("20240527124214_asem6")]
    partial class asem6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("BlogDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 458, DateTimeKind.Local).AddTicks(3706));

                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 458, DateTimeKind.Local).AddTicks(2487));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.BlogAttachement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 458, DateTimeKind.Local).AddTicks(671));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 454, DateTimeKind.Local).AddTicks(1727));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.ContactRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 454, DateTimeKind.Local).AddTicks(8764));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Gallery", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 458, DateTimeKind.Local).AddTicks(8864));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Login", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 454, DateTimeKind.Local).AddTicks(6898));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 455, DateTimeKind.Local).AddTicks(566));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Problem", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 458, DateTimeKind.Local).AddTicks(6977));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 455, DateTimeKind.Local).AddTicks(9647));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 15, 42, 14, 456, DateTimeKind.Local).AddTicks(4124));
