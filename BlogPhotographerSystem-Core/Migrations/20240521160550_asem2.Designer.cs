...
namespace BlogPhotographerSystem_Core.Migrations
{
    ...
    [Migration("20240521160550_asem2")]
    partial class asem2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("BlogDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 608, DateTimeKind.Local).AddTicks(5628));

                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 608, DateTimeKind.Local).AddTicks(4680));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.BlogAttachement", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 608, DateTimeKind.Local).AddTicks(3144));
                    ...
                    b.ToTable("BlogAttachements", t =>
                        {
                            t.HasCheckConstraint("CH_BlogAttachement_FileName", "NOT (FileName REGEXP '[0-9~!@#$%^&*()_+=-]')");
                        });
                });
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 605, DateTimeKind.Local).AddTicks(594));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.ContactRequest", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 605, DateTimeKind.Local).AddTicks(7328));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Login", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 605, DateTimeKind.Local).AddTicks(5717));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 605, DateTimeKind.Local).AddTicks(9065));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Problem", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 608, DateTimeKind.Local).AddTicks(8778));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 606, DateTimeKind.Local).AddTicks(4759));
            ...
            modelBuilder.Entity("BlogPhotographerSystem_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 21, 19, 5, 50, 606, DateTimeKind.Local).AddTicks(8791));
